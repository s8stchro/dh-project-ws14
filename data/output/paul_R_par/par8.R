library(ggplot2)
par8 <- read.csv("../../data/output/paul_freq_par/par8_frequency.csv", header=TRUE, sep="\t")
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt79.png")
png(filename)
lt79 <- par8[which(par8$letter==79),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt73.png")
png(filename)
lt73 <- par8[which(par8$letter==73),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt67.png")
png(filename)
lt67 <- par8[which(par8$letter==67),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt76.png")
png(filename)
lt76 <- par8[which(par8$letter==76),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt68.png")
png(filename)
lt68 <- par8[which(par8$letter==68),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt69.png")
png(filename)
lt69 <- par8[which(par8$letter==69),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt70.png")
png(filename)
lt70 <- par8[which(par8$letter==70),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt74.png")
png(filename)
lt74 <- par8[which(par8$letter==74),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt72.png")
png(filename)
lt72 <- par8[which(par8$letter==72),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt66.png")
png(filename)
lt66 <- par8[which(par8$letter==66),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt78.png")
png(filename)
lt78 <- par8[which(par8$letter==78),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt71.png")
png(filename)
lt71 <- par8[which(par8$letter==71),]
...
letters <- unique(par8$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par8_lt75.png")
png(filename)
lt75 <- par8[which(par8$letter==75),]
