library(ggplot2)
par12 <- read.csv("../../data/output/paul_freq_par/par12_frequency.csv", header=TRUE, sep="\t")
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt66.png")
png(filename)
lt66 <- par12[which(par12$letter==66),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt67.png")
png(filename)
lt67 <- par12[which(par12$letter==67),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt77.png")
png(filename)
lt77 <- par12[which(par12$letter==77),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt74.png")
png(filename)
lt74 <- par12[which(par12$letter==74),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt78.png")
png(filename)
lt78 <- par12[which(par12$letter==78),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt79.png")
png(filename)
lt79 <- par12[which(par12$letter==79),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt70.png")
png(filename)
lt70 <- par12[which(par12$letter==70),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt69.png")
png(filename)
lt69 <- par12[which(par12$letter==69),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt71.png")
png(filename)
lt71 <- par12[which(par12$letter==71),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt76.png")
png(filename)
lt76 <- par12[which(par12$letter==76),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt75.png")
png(filename)
lt75 <- par12[which(par12$letter==75),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt72.png")
png(filename)
lt72 <- par12[which(par12$letter==72),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt73.png")
png(filename)
lt73 <- par12[which(par12$letter==73),]
...
letters <- unique(par12$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par12_lt68.png")
png(filename)
lt68 <- par12[which(par12$letter==68),]
