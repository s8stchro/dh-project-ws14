library(ggplot2)
par2 <- read.csv("../../data/output/paul_freq_par/par2_frequency.csv", header=TRUE, sep="\t")
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt73.png")
png(filename)
lt73 <- par2[which(par2$letter==73),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt74.png")
png(filename)
lt74 <- par2[which(par2$letter==74),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt79.png")
png(filename)
lt79 <- par2[which(par2$letter==79),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt70.png")
png(filename)
lt70 <- par2[which(par2$letter==70),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt67.png")
png(filename)
lt67 <- par2[which(par2$letter==67),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt75.png")
png(filename)
lt75 <- par2[which(par2$letter==75),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt68.png")
png(filename)
lt68 <- par2[which(par2$letter==68),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt72.png")
png(filename)
lt72 <- par2[which(par2$letter==72),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt66.png")
png(filename)
lt66 <- par2[which(par2$letter==66),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt71.png")
png(filename)
lt71 <- par2[which(par2$letter==71),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt77.png")
png(filename)
lt77 <- par2[which(par2$letter==77),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt76.png")
png(filename)
lt76 <- par2[which(par2$letter==76),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt78.png")
png(filename)
lt78 <- par2[which(par2$letter==78),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par2_lt69.png")
png(filename)
lt69 <- par2[which(par2$letter==69),]
