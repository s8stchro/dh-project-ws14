library(ggplot2)
par1 <- read.csv("../../data/output/paul_freq_par/par1_frequency.csv", header=TRUE, sep="\t")
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt70.png")
png(filename)
lt70 <- par1[which(par1$letter==70),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt69.png")
png(filename)
lt69 <- par1[which(par1$letter==69),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt68.png")
png(filename)
lt68 <- par1[which(par1$letter==68),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt79.png")
png(filename)
lt79 <- par1[which(par1$letter==79),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt77.png")
png(filename)
lt77 <- par1[which(par1$letter==77),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt74.png")
png(filename)
lt74 <- par1[which(par1$letter==74),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt72.png")
png(filename)
lt72 <- par1[which(par1$letter==72),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt67.png")
png(filename)
lt67 <- par1[which(par1$letter==67),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt75.png")
png(filename)
lt75 <- par1[which(par1$letter==75),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt66.png")
png(filename)
lt66 <- par1[which(par1$letter==66),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt73.png")
png(filename)
lt73 <- par1[which(par1$letter==73),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt71.png")
png(filename)
lt71 <- par1[which(par1$letter==71),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt76.png")
png(filename)
lt76 <- par1[which(par1$letter==76),]
...
letters <- unique(par1$letter)
filename <- paste0("../../data/output/paul_R_par/plots/par1_lt78.png")
png(filename)
lt78 <- par1[which(par1$letter==78),]
