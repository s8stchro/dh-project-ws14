library(ggplot2)
f67 <- read.csv("../data/output/paul_freq/67_frequency.csv", header=TRUE, sep="\t")
particles <- unique(f67$particle)
filename <- paste0("../data/output/paul_R/plots/f67_par1_",particles[1],".png")
png(filename)
par1 <- f67[which(f67$particle==particles[1]),]
...
particles <- unique(f67$particle)
filename <- paste0("../data/output/paul_R/plots/f67_par2_",particles[2],".png")
png(filename)
par2 <- f67[which(f67$particle==particles[2]),]
...
particles <- unique(f67$particle)
filename <- paste0("../data/output/paul_R/plots/f67_par3_",particles[3],".png")
png(filename)
par3 <- f67[which(f67$particle==particles[3]),]
...
particles <- unique(f67$particle)
filename <- paste0("../data/output/paul_R/plots/f67_par4_",particles[4],".png")
png(filename)
par4 <- f67[which(f67$particle==particles[4]),]
...
particles <- unique(f67$particle)
filename <- paste0("../data/output/paul_R/plots/f67_par5_",particles[5],".png")
png(filename)
par5 <- f67[which(f67$particle==particles[5]),]
...
particles <- unique(f67$particle)
filename <- paste0("../data/output/paul_R/plots/f67_par6_",particles[6],".png")
png(filename)
par6 <- f67[which(f67$particle==particles[6]),]
...
particles <- unique(f67$particle)
filename <- paste0("../data/output/paul_R/plots/f67_par7_",particles[7],".png")
png(filename)
par7 <- f67[which(f67$particle==particles[7]),]
...
particles <- unique(f67$particle)
filename <- paste0("../data/output/paul_R/plots/f67_par8_",particles[8],".png")
png(filename)
par8 <- f67[which(f67$particle==particles[8]),]
...
particles <- unique(f67$particle)
filename <- paste0("../data/output/paul_R/plots/f67_par9_",particles[9],".png")
png(filename)
par9 <- f67[which(f67$particle==particles[9]),]
