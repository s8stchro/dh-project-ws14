library(ggplot2)
f76 <- read.csv("../data/output/paul_freq/76_frequency.csv", header=TRUE, sep="\t")
particles <- unique(f76$particle)
filename <- paste0("../data/output/paul_R/plots/f76_par1_",particles[1],".png")
png(filename)
par1 <- f76[which(f76$particle==particles[1]),]
...
particles <- unique(f76$particle)
filename <- paste0("../data/output/paul_R/plots/f76_par2_",particles[2],".png")
png(filename)
par2 <- f76[which(f76$particle==particles[2]),]
...
particles <- unique(f76$particle)
filename <- paste0("../data/output/paul_R/plots/f76_par3_",particles[3],".png")
png(filename)
par3 <- f76[which(f76$particle==particles[3]),]
...
particles <- unique(f76$particle)
filename <- paste0("../data/output/paul_R/plots/f76_par4_",particles[4],".png")
png(filename)
par4 <- f76[which(f76$particle==particles[4]),]
...
particles <- unique(f76$particle)
filename <- paste0("../data/output/paul_R/plots/f76_par5_",particles[5],".png")
png(filename)
par5 <- f76[which(f76$particle==particles[5]),]
...
particles <- unique(f76$particle)
filename <- paste0("../data/output/paul_R/plots/f76_par6_",particles[6],".png")
png(filename)
par6 <- f76[which(f76$particle==particles[6]),]
