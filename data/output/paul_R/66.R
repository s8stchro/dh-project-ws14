library(ggplot2)
f66 <- read.csv("../data/output/paul_freq/66_frequency.csv", header=TRUE, sep="\t")
particles <- unique(f66$particle)
filename <- paste0("../data/output/paul_R/plots/f66_par1_",particles[1],".png")
png(filename)
par1 <- f66[which(f66$particle==particles[1]),]
...
particles <- unique(f66$particle)
filename <- paste0("../data/output/paul_R/plots/f66_par2_",particles[2],".png")
png(filename)
par2 <- f66[which(f66$particle==particles[2]),]
...
particles <- unique(f66$particle)
filename <- paste0("../data/output/paul_R/plots/f66_par3_",particles[3],".png")
png(filename)
par3 <- f66[which(f66$particle==particles[3]),]
...
particles <- unique(f66$particle)
filename <- paste0("../data/output/paul_R/plots/f66_par4_",particles[4],".png")
png(filename)
par4 <- f66[which(f66$particle==particles[4]),]
...
particles <- unique(f66$particle)
filename <- paste0("../data/output/paul_R/plots/f66_par5_",particles[5],".png")
png(filename)
par5 <- f66[which(f66$particle==particles[5]),]
...
particles <- unique(f66$particle)
filename <- paste0("../data/output/paul_R/plots/f66_par6_",particles[6],".png")
png(filename)
par6 <- f66[which(f66$particle==particles[6]),]
...
particles <- unique(f66$particle)
filename <- paste0("../data/output/paul_R/plots/f66_par7_",particles[7],".png")
png(filename)
par7 <- f66[which(f66$particle==particles[7]),]
