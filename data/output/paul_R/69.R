library(ggplot2)
f69 <- read.csv("../data/output/paul_freq/69_frequency.csv", header=TRUE, sep="\t")
particles <- unique(f69$particle)
filename <- paste0("../data/output/paul_R/plots/f69_par1_",particles[1],".png")
png(filename)
par1 <- f69[which(f69$particle==particles[1]),]
...
particles <- unique(f69$particle)
filename <- paste0("../data/output/paul_R/plots/f69_par2_",particles[2],".png")
png(filename)
par2 <- f69[which(f69$particle==particles[2]),]
...
particles <- unique(f69$particle)
filename <- paste0("../data/output/paul_R/plots/f69_par3_",particles[3],".png")
png(filename)
par3 <- f69[which(f69$particle==particles[3]),]
...
particles <- unique(f69$particle)
filename <- paste0("../data/output/paul_R/plots/f69_par4_",particles[4],".png")
png(filename)
par4 <- f69[which(f69$particle==particles[4]),]
...
particles <- unique(f69$particle)
filename <- paste0("../data/output/paul_R/plots/f69_par5_",particles[5],".png")
png(filename)
par5 <- f69[which(f69$particle==particles[5]),]
...
particles <- unique(f69$particle)
filename <- paste0("../data/output/paul_R/plots/f69_par6_",particles[6],".png")
png(filename)
par6 <- f69[which(f69$particle==particles[6]),]
...
particles <- unique(f69$particle)
filename <- paste0("../data/output/paul_R/plots/f69_par7_",particles[7],".png")
png(filename)
par7 <- f69[which(f69$particle==particles[7]),]
...
particles <- unique(f69$particle)
filename <- paste0("../data/output/paul_R/plots/f69_par8_",particles[8],".png")
png(filename)
par8 <- f69[which(f69$particle==particles[8]),]
