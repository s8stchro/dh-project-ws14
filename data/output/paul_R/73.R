library(ggplot2)
f73 <- read.csv("../data/output/paul_freq/73_frequency.csv", header=TRUE, sep="\t")
particles <- unique(f73$particle)
filename <- paste0("../data/output/paul_R/plots/f73_par1_",particles[1],".png")
png(filename)
par1 <- f73[which(f73$particle==particles[1]),]
...
particles <- unique(f73$particle)
filename <- paste0("../data/output/paul_R/plots/f73_par2_",particles[2],".png")
png(filename)
par2 <- f73[which(f73$particle==particles[2]),]
...
particles <- unique(f73$particle)
filename <- paste0("../data/output/paul_R/plots/f73_par3_",particles[3],".png")
png(filename)
par3 <- f73[which(f73$particle==particles[3]),]
...
particles <- unique(f73$particle)
filename <- paste0("../data/output/paul_R/plots/f73_par4_",particles[4],".png")
png(filename)
par4 <- f73[which(f73$particle==particles[4]),]
...
particles <- unique(f73$particle)
filename <- paste0("../data/output/paul_R/plots/f73_par5_",particles[5],".png")
png(filename)
par5 <- f73[which(f73$particle==particles[5]),]
...
particles <- unique(f73$particle)
filename <- paste0("../data/output/paul_R/plots/f73_par6_",particles[6],".png")
png(filename)
par6 <- f73[which(f73$particle==particles[6]),]
...
particles <- unique(f73$particle)
filename <- paste0("../data/output/paul_R/plots/f73_par7_",particles[7],".png")
png(filename)
par7 <- f73[which(f73$particle==particles[7]),]
