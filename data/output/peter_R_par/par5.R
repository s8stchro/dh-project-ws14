library(ggplot2)
par5 <- read.csv("../../data/output/peter_freq_par/par5_frequency.csv", header=TRUE, sep="\t")
letters <- unique(par5$letter)
filename <- paste0("../../data/output/peter_R_par/plots/par5_lt81.png")
png(filename)
lt81 <- par5[which(par5$letter==81),]
...
letters <- unique(par5$letter)
filename <- paste0("../../data/output/peter_R_par/plots/par5_lt82.png")
png(filename)
lt82 <- par5[which(par5$letter==82),]
