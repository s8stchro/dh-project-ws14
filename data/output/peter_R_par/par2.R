library(ggplot2)
par2 <- read.csv("../../data/output/peter_freq_par/par2_frequency.csv", header=TRUE, sep="\t")
letters <- unique(par2$letter)
filename <- paste0("../../data/output/peter_R_par/plots/par2_lt82.png")
png(filename)
lt82 <- par2[which(par2$letter==82),]
...
letters <- unique(par2$letter)
filename <- paste0("../../data/output/peter_R_par/plots/par2_lt81.png")
png(filename)
lt81 <- par2[which(par2$letter==81),]
